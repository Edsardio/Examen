		...
		<div class="column" style="top:200px;">
			...
			<div class="ui stacked segment">
				...
				<div class="three fields">
					<div class="field">
						<label style="float:left;">Voornaam</label>						
					...
					<div class="field">
						<label style="float:left;">Tussenvoegsel</label>
					...
					<div class="field">
						<label style="float:left;">Achternaam</label>
						<div class="ui left icon labeled input">
							<i class="user icon"></i>
				...
				<div class="two fields">
					<div class="field">
						<label style="float:left;">Wachtwoord</label>
						<div class="ui left icon labeled input">
							<i class="lock icon"></i>
					...
					<div class="field">
						<label style="float:left;">Herhaal wachtwoord</label>
						<div class="ui left icon labeled input">
							<i class="lock icon"></i>
				...
				<div class="two fields">
					...
					<div class="field">
						<label style="float:left;">Woonplaats</label>
						<div class="ui left icon labeled input">
							<i class="home icon"></i>
				...
				<div class="field">
					<label style="float:left;">Telefoonnummer</label>
					<div class="ui left icon labeled input">
				...
				<div class="field">
					<label style="float:left;">Mobiel</label>
					<div class="ui left icon labeled input">
						<i class="phone icon"></i>
				...
				<div class="field">
					<label style="float:left;">Geboortedatum</label>
					<div class="ui left icon labeled input">
