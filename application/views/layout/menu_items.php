...
<?php if (isset($_SESSION['user_id'])) {?><a class="item <?php if(isset($segments['2']) && $segments['2'] === 'mijncursussen'){echo 'active';}?>" href="<?php $this->config->base_url(); ?>mijncursussen">Mijn Cursussen</a><?php } ?>
